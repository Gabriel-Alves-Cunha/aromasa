		...
		<Container>
			...
			<Content>
				...
				<p>
					...
					informação que o Aromasa oferece no site e com caráter enunciativo,
					mas não limitativo:
				</p>
				<ul>
					<li>
					...
					<li>
						...
						xenofóbica, ou apostas online (ex.:
					...
					<li>
						...
						(softwares) do Aromasa, de seus fornecedores ou terceiros, para
			...
			<Content style={{ marginBottom: 200 }}>
				...
				<p>
					...
					dessas restrições e poderá ser rescindida por Aromasa a qualquer
				...
				<h2>4. Limitações</h2>
				<p>
					Em nenhum caso o Aromasa ou seus fornecedores serão responsáveis ​​por
					...
					incapacidade de usar os materiais em Aromasa, mesmo que Aromasa ou um
					representante autorizado da Aromasa tenha sido notificado oralmente ou
				...
				<p>
					...
					tipográficos ou fotográficos. Aromasa não garante que qualquer
					material em seu site seja preciso, completo ou atual. Aromasa pode
				...
				<p>
					...
					qualquer link não implica endosso por Aromasa do site. O uso de
					qualquer site vinculado é por conta e risco do usuário.
				</p>

				<h3>Modificações</h3>
				<p>
					O Aromasa pode revisar estes termos de serviço do site a qualquer
